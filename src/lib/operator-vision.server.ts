// =============================================================================
// Lógica de datos del Visor Operativo (server-only).
// Extraída de operator-vision.functions.ts sin cambios de comportamiento para
...
export type OperatorVisionPayload = Awaited<ReturnType<typeof fetchOperatorVisionData>>;
